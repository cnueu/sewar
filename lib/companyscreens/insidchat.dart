...
class InsideCompanyChat extends StatefulWidget {
  final bool isDark;
  final String modelName; 
  final String avatarPath;

  const InsideCompanyChat({
    Key? key,
  ...
  @override
  State<InsideCompanyChat> createState() => _InsideCompanyChatState();
}

class _InsideCompanyChatState extends State<InsideCompanyChat> {
  final List<Map<String, dynamic>> messages = [
    {
      'isUser': true,
      'sender': 'Company',
      'message':
          'حسنًا الآن تحدث معي بالعربية و قدم لي معلومات عن أفضل الأيام لإنشاء مباراة',
      'isRTL': true,
    },
    {
      'isUser': false,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          Container(
            decoration: AppStyles.companybackgroundDecoration(isDark: widget.isDark),
          ),
          SafeArea(
            child: Column(
              children: [
